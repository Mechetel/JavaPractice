...
public class Credit_Calculator {
	...
	public static void main(String[] args) {
		...
		Font textfield_font = new Font("Dialog", Font.ITALIC, 20);
		...
		Font label_font = new Font("Arial", Font.ITALIC, 14);
		...
		Font combobox_font = new Font("Dialog", Font.ITALIC, 15);
		 ...
		 * по схеме (имя поля, координата Х, координата У, ширина, высота, стиль) */
		create.CreateComboBox(period_box, 243, 80, 85, 30, combobox_font);
		...
		create.CreateComboBox(year_box, 180, 260, 100, 30, combobox_font);	
